...
sheet = client.create('тест файл')
sheet.share('oleksandrhryshko790@gmail.com', perm_type='user', role='writer')


data.share('oleksandrhryshko790@gmail.com', perm_type='user', role='writer')
